...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("bpResult");
    ...
    private void displayData(String data) {
        if (data.length() <=8){
            ...
            databaseReference.push().child("bpdata").setValue(data);

            Toast.makeText(record.this,
                    "DATA SAVE", Toast.LENGTH_LONG).show();
    ...
    public void readdata(View v){
        if(mBluetoothLeService != null) {
            mBluetoothLeService.writeCustomCharacteristic("t180$");
            Toast.makeText(record.this,
                    "Interval Start at 3 mins", Toast.LENGTH_LONG).show();
            }
    }
